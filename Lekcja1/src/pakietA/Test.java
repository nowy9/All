...
kalkulator. Niech typ ten posiada następujące wartości MULTIPY, DIVIDE, ADD,
SUBTRACT. Niech typ ten posiada metodę public double perform(double x, double y),
która zwróci wynik odpowiedniej operacji. Na przykład Computation.ADD.perform
(1, -5) powinno zwrócić -4.
*/
public class Test {
    public enum Computation {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Created by Pawełek");
        }
    }
}